...
'''Implements test cases using unittest. Sets up WebDriver (setUp), performs test actions (test_search_and_add_to_cart), and handles cleanup (tearDown).'''
class TestShopping(unittest.TestCase):
    ...
    '''tearDown method quits the WebDriver after each test.'''
    def tearDown(self):
        self.driver.quit()
